...
export const styles = StyleSheet.create({
  ...
  formContainer: {
    ...
    borderTopEndRadius: 60,// Arredonda os cantos do contêiner
    backgroundColor: "#fff", // Adiciona fundo branco
    paddingTop: 40, // Aumenta o padding no topo para dar mais espaçamento
    marginTop: -50, // Pode ser ajustado para sobrepor um pouco a imagem de fundo
},
